...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "fortunate@neoterra.co.za", Zipcode = "10442" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("fortunate@neoterra.co.za", "Forms"), null);
